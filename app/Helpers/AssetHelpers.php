...
function getAssetKeys($isCharacter = false) {
    if (!$isCharacter) {
        return ['items', 'awards', 'currencies', 'raffle_tickets', 'loot_tables', 'user_items', 'user_awards', 'characters', 'themes', 'recipes'];
    } else {
        return ['currencies', 'items', 'character_items', 'loot_tables', 'awards', 'statuses'];
    }
}
