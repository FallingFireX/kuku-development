...
class Feature extends Model {
     ...
     */
    protected $fillable = [
        'feature_category_id', 'species_id', 'subtype_id', 'rarity_id', 'name', 'has_image', 'description', 'parsed_description', 'parent_id', 'is_visible', 'full_page', 'hash', 'feature_subcategory_id',
    ];
