...
class CharacterController extends Controller {
    ...
    */
    ...
    public function postEditCharacterProfile(Request $request, CharacterManager $service, $slug) {
        ...
        if ($service->updateCharacterProfile($request->only(['name', 'link', 'text', 'is_gift_art_allowed', 'is_gift_writing_allowed', 'is_trading', 'character_warning', 'custom_values_group', 'custom_values_name', 'custom_values_data', 'genotype', 'phenotype', 'eyecolor', 'gender', 'diet', 'bio', 'alert_user', 'is_links_open']), $this->character, Auth::user(), !$isOwner)) {
