    ...
    */
    ...
    public function postCreateCharacter(Request $request, CharacterManager $service)
    {
        ...
        $data = $request->only([
            ...
            'image', 'thumbnail', 'image_description', 'transformation_id','transformation_info','transformation_description', 'genotype', 'phenotype', 'gender',
        ]);
    ...
    public function postCreateMyo(Request $request, CharacterManager $service)
    {
        ...
        $data = $request->only([
            ...
            'species_id', 'subtype_id', 'rarity_id', 'feature_id', 'feature_data',
            'image', 'thumbnail', 'transformation_id','transformation_info','transformation_description', 'genotype', 'phenotype', 'gender',
        ]);
