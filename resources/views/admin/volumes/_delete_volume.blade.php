@if ($volume)
    ...
    <p>You are about to delete the {{ __('volumes.volume') }} <strong>{{ $volume->name }}</strong>. This is not reversible. If this {{ __('volumes.volume') }} exists in at least one user's possession, you will not be able to delete this
        {{ __('volumes.volume') }}.</p>
