@if ($book)
    ...
    <p>You are about to delete the {{ __('volumes.book') }} <strong>{{ $book->name }}</strong>. This is not reversible. If {{ __('volumes.volumes') }} in this {{ __('volumes.book') }} exist, you will not be able to delete this
        {{ __('volumes.book') }}.</p>
