...
@section('admin-content')
    ...
    <p>You can create new dev log posts here. Creating a dev log post alerts every user that have the notification setting turned on (by default) that there is a new post, unless the post is marked as not viewable (see the post creation page for
        details).</p>
