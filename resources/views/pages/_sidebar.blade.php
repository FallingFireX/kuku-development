    ...
    @if (Auth::check())
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="d-flex flex-column ms-4 pl-2 pb-1 gap-2">
                <a href="{{ url('notifications') }}" class="btn {{ Auth::user()->notifications_unread ? 'btn-warning' : 'btn-secondary' }} 
                ...
                <a href="{{ url('account/settings') }}" class="btn btn-secondary rounded-circle p-2 mb-1 d-inline-flex justify-content-center align-items-center" style="width: 40px; height: 40px; text-decoration: none; color: inherit;">
                    <i class="fas fa-cog"></i>
                </a>

                <a href="{{ Auth::user()->url }}" class="btn btn-secondary rounded-circle p-2 mb-1 d-inline-flex justify-content-center align-items-center" style="width: 40px; height: 40px; text-decoration: none; color: inherit;">
