            ...
            <div class="col-md-8">
                <div class="tracker_type d-flex mb-4">
                    <div class="card w-100 p-3 rounded border border-secondary mr-3">
                        ...
                        <label for="single"><h5>Single Tracker</h5><p class="mb-0">For tracker cards that contain singular data. Such as artwork with a single image or literature with one stories.</p></label>
                    </div>
                    <div class="card w-100 p-3 rounded border border-secondary ml-3">
                        <input type="radio" id="multi" name="tracker_type" value="multi">
                        <label for="multi"><h5>Multi Tracker</h5><p class="mb-0">For more advanced tracker cards. Great for sketch pages with multiple pieces to count or bundled literature stories.</p></label>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="pointValues" class="accordion mb-4">
                    <div class="tracker_0 tracker-item">
                        <div class="card rounded bg-transparent border border-secondary">
                            <div class="card-header bg-dark d-flex justify-content-between align-items-center" id="0"><button class="btn h2 btn-link btn-block text-left" style="text-decoration:none;" type="button" data-toggle="collapse" data-target="#collapse-0" aria-expanded="true" aria-controls="collapse-0">Tracker #0</button><a href="#" class="remove-tracker multi-only hide btn btn-danger">-</a></div>
