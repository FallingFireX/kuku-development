<div class="row world-entry">
    ...
    <div class="{{ $prompt->has_image ? 'col-md-9' : 'col-12' }}">
        ...
        <div class="world-entry-text">
            <p>{{ $prompt->summary }}</p>
            <div class="text-right"><a data-toggle="collapse" href="#prompt-{{ $prompt->id }}" class="text-primary"><strong>Toggle details visibility...</strong></a></div>
            <div class="collapse show" id="prompt-{{ $prompt->id }}">
                <h4>Details</h4>
