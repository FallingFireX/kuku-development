<ul>
    <li class="sidebar-header"><a href="{{ $character->url }}" class="card-link">{{ $character->fullName, 20, $end = '...' }}</a></li>
    <li class="sidebar-section">
        ...
        @if ($character->getLineageBlacklistLevel() < 1)
            <div class="sidebar-item"><a href="{{ $character->url . '/lineage' }}" class="{{ set_active('character/' . $character->slug . '/lineage') }}">Descendants</a></div>
        @endif
