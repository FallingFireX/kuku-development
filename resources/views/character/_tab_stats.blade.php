...
@if ($parent)
    ...
    <div class="row justify-content-center text-center">
        <div class="col-md-3">
            ...
            <a href="{{ $parent->parent->url }}" class="h5 mb-0">
                @if (!$parent->parent->is_visible)
                    <i class="fas fa-eye-slash"></i>
                @endif {{ $parent->parent->fullName }}
            </a>
            <div class="small">
    ...
    <div class="row justify-content-center text-center">
        @foreach ($children as $link)
            <div class="col-md-3">
                ...
                <a href="{{ $link->child->url }}" class="h5 mb-0">
                    @if (!$link->child->is_visible)
                        <i class="fas fa-eye-slash"></i>
                    @endif {{ $link->child->fullName }}
                </a>
                <div class="small">
