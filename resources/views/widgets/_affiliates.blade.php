...
<div class="mt-2 text-center">
    <h5>Our Affiliates</h5>
        ...
        <div class="row mx-2 my-1" style="font-size:0.9em;">
            <div class="col-6 text-left mx-0 px-0">@if($open)<a href="{{ url('affiliates/apply')}}" style="color:var(--dark);"><b>Become an Affiliate!</b></a>@endif</div>
